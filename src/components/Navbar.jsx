    ...
    <div className="bg-white shadow flex justify-between items-center px-8 py-5">
      ...
      <div className="flex items-center">
        ...
        <button
          ...
          className="text-2xl mr-5 hover:text-blue-600 transition"
        >
          <FaBars />
        </button>
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          {open && (
            ...
            <div className="absolute right-0 mt-4 w-56 bg-white rounded-xl shadow-xl border overflow-hidden z-50">
              ...
              <button className="flex items-center gap-3 w-full px-5 py-3 hover:bg-red-50 text-red-600 transition">
